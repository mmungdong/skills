---
name: crwu-audit-asset-debt
description: Use when crwu-audit has selected the canonical 债权 asset label for professional asset-object review.
---
...
- 同一份 `route_profile`，且 `asset_types[]` 已命中 canonical `债权`；
...
4. 输出对象专业 findings；每条均带 `source_skills[]`，其中至少包含 `crwu-audit-asset-debt`。相同事实由其他技能共同支持时保留全部来源，冲突时并列交人工复核。
